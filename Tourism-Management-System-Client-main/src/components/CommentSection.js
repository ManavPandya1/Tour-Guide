...
function CommentSection(props) {
  ...
  return (
    <div className="container mt-5" style={{backgroundColor : "white",borderRadius:"10px"}}>
      <h2>Comments</h2>
      ...
      {!isAdmin && (
      <button className="btn btn-primary" onClick={handleSubmitComment} style={{marginLeft:"88%",marginBottom:"5px"}}>
        Add Comment
      </button>
      )}
    </div>
