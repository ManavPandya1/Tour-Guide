...
export default function AddGuide() {
  ...
  return (
    <>
      ...
      <div className="d-flex justify-content-center align-items-center vh-70" style={{ backgroundImage: `url(${tourismImage})`, backgroundPosition: "center", backgroundSize: 'cover', backgroundAttachment: "fixed", position: "sticky" }}>
