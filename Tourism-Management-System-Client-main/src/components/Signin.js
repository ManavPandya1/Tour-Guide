  ...
  return (
    <>
      ...
      <div  className="d-flex justify-content-center align-items-center vh-100" style={{ position: "sticky", backgroundImage: `url(${tourismImage})`, backgroundPosition: "center", backgroundSize: 'cover' }}>
        <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1" id="bgcolor1" style={{borderRadius:"10px"}}>
          ...
          <form method="post" className="mx-1 mx-md-4">
            ...
            <div className="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
              ...
              <button type="button" className="btn btn-clr btn-secondary btn-lg mx-2" onClick={() => { window.location.href = '/'; }}>Sign Up</button>
            </div>
